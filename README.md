...
### STEP 15 install ERPNext latest version in bench & site
    ...
    bench --site muddassir.com install-app erpnext
...
### STEP 16  Create a new user
    ...
    sudo adduser muddassir-frappe
    sudo usermod -aG sudo muddassir-frappe
    su - muddassir-frappe
...
### Step 17 setup production
    ...
    sudo bench setup production muddassir-frappe
    bench restart
